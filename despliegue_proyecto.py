...
v_victima = ['NO', 'SI']
v_subregiones = ['BAJO CAUCA', 'MAGDALENA MEDIO', 'NORDESTE', 'NORTE', 'OCCIDENTE', 'ORIENTE', 'SUROESTE', 'URABA', 'VALLE DE ABURRA'].sort()
v_programas_cursados = programas_cursados_lista.sort()
v_universidades = [
...
v_formacion = ['NORMALISTA', 'POSTGRADO', 'TECNICA PROFESIONAL', 'TECNOLOGICA', 'UNIVERSITARIA'].sort()
